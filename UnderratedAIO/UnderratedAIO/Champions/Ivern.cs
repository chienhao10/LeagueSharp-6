...
namespace UnderratedAIO.Champions
{
    internal class Ivern
    {
        ...
        {
            if (hero.CharData.BaseSkinName == "Ivern" && args.Slot == SpellSlot.W)
            {
        ...
        private void Combo()
        {
            ...
            if (target != null)
            {
                ...
                if (config.Item("usew", true).GetValue<bool>() && W.IsReady())
                {
                    ...
                    if (config.Item("usewSelf", true).GetValue<bool>() && !player.IsWindingUp &&
        ...
        private void castW(Obj_AI_Hero t)
        {
