...
namespace UnderratedAIO.Helpers
{
    ...
    public static class Orbwalking
    {
            ...
            bool randomizeMinDistance = true)
        {
            ...
            if (Utils.GameTimeTickCount - LastMoveCommandT < 70 + _delay + Math.Min(60, Game.Ping) && !overrideTimer &&
                angle < 60)
            {
                return;
            }
        ...
        public class Orbwalker
        {
            ...
            public Orbwalker(Menu attachToMenu)
            {
                ...
                /* Missile check */
                _config.AddItem(new MenuItem("Support", "Support mode", true).SetShared().SetValue(false));
                /*Load the menu*/
                _config.AddItem(
            ...
            private void GameOnOnGameUpdate(EventArgs args)
            {
                try
                {
                    ...
                    Orbwalk(
                        ...
                        _config.Item("meleeMagnet").GetValue<bool>());
                }
                catch (Exception e)
                {
                    Console.WriteLine(e);
